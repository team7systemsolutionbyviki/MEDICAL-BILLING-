...
async function syncFromCloud() {
    ...
    try {
        ...
        const collections = ['products', 'sales', 'settings', 'purchases', 'expenses', 'customers', 'suppliers', 'admins', 'supplierPayments', 'customerPayments', 'categories', 'expenseCategories'];
